...
슈퍼관리자(superAdmin), 본사 최고관리자(primary), 센터장(owner), 매니저(manager)는 모든 종류의 쿠폰을 자기 권한 범위 회원에게 적용할 수 있습니다.
...
본사 발급 쿠폰 중 고할인 쿠폰(50% 이상 또는 50만원 이상)의 적용은 owner 이상 권한자만 처리할 수 있으며, 매니저가 시도 시 적용 버튼 위에 "고할인 쿠폰 적용은 센터장 승인이 필요합니다" 안내가 표시되고 버튼이 비활성화됩니다.
