...
슈퍼관리자(superAdmin), 본사 최고관리자(primary), 센터장(owner), 매니저(manager)는 모든 회원의 목표를 설정·수정·삭제할 수 있습니다.
...
목표 설정 권한이 트레이너에게는 본인 담당 회원으로 제한되는 것은, 회원과 트레이너 사이의 운동 계획 책임 구조를 흐트러뜨리지 않기 위해서입니다. 매니저와 센터장은 운영 차원에서 모든 회원의 목표를 조정할 수 있지만, 일반적으로는 담당 트레이너와 협의 후 수정하는 것이 운영 가이드입니다.
