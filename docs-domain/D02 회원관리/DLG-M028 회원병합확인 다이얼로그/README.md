...
슈퍼관리자(superAdmin), 본사 최고관리자(primary)는 모든 회원 병합을 처리할 수 있습니다. 동일 브랜드 내 어느 지점 회원도 가능하며, 다른 브랜드 간 병합도 본사 권한으로 처리 가능합니다.

센터장(owner)은 자기 지점 회원끼리의 병합만 처리할 수 있습니다. 다른 지점 회원이 대상에 포함된 경우 본사 권한자에게 요청해야 합니다.

매니저(manager)는 회원 병합 권한이 없습니다. 일부 운영에서는 매니저가 병합 요청을 본사·센터장에 전달하는 흐름이 운영됩니다.
