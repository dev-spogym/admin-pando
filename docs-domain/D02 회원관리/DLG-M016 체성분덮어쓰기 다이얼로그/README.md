...
superAdmin, primary, Owner(지점장), 매니저(manager), 트레이너(trainer)는 모두 덮어쓰기를 수행할 수 있습니다. 트레이너는 자신이 담당하는 회원의 체성분에 한해서만 덮어쓰기가 가능하며, 다른 회원의 체성분은 DLG-M015 자체에 진입할 수 없으므로 이 다이얼로그도 보이지 않습니다.
