...
슈퍼관리자(superAdmin)와 본사 최고관리자(primary)는 전체 지점의 모든 미수금·할부 회차에 대해 납입 처리를 수행할 수 있습니다. 본사 통합 모드에서도 동작이 동일합니다.

센터장(owner)과 매니저(manager)는 자기 지점의 미수금·할부 회차에 대해 납입 처리를 수행할 수 있습니다. PAY-03 권한 규칙에 따라 결제 기한 연장도 owner 권한자가 수행 가능합니다.
