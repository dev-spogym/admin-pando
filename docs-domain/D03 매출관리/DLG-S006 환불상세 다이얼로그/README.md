...
슈퍼관리자(superAdmin)와 본사 최고관리자(primary)는 전체 지점의 모든 환불 상세를 조회할 수 있습니다. 본사 통합 모드에서 익명화된 환불의 일시 마스킹 해제 요청도 가능합니다.

센터장(owner)과 매니저(manager)는 자기 지점의 환불 상세를 조회할 수 있습니다. 다른 지점 환불은 다이얼로그가 열리지 않습니다. 거절된 환불의 재시도 진입 링크는 owner·manager에게 활성화됩니다.
...
위약금 면제 권한은 슈퍼관리자·센터장에게만 있으며, 면제 사유는 반드시 기록됩니다. 다이얼로그에서 면제 여부와 면제 사유가 항상 함께 표시되어, 분쟁 시 면제 근거를 확인할 수 있습니다.
