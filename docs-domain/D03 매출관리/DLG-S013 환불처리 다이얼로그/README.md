...
위약금 면제 토글은 슈퍼관리자·센터장 한정으로 표시되며, 토글을 켜면 위약금이 0원으로 자동 적용되고 면제 사유 입력란이 노출됩니다. 면제 사유는 필수 입력입니다.
...
여섯째, 위약금 면제 사유 검증입니다. 슈퍼관리자·센터장이 위약금 면제 토글을 켠 경우 면제 사유가 필수입니다.
...
위약금 면제 상태는 슈퍼관리자·센터장이 면제 토글을 켠 상태로, 면제 사유 입력란이 필수로 표시됩니다.
...
슈퍼관리자(superAdmin)와 본사 최고관리자(primary)는 전체 지점의 환불 처리와 위약금 면제·수기 조정을 모두 수행할 수 있습니다.

센터장(owner)은 자기 지점의 환불 처리·위약금 면제·수기 조정이 가능합니다.
...
위약금 면제 권한(슈퍼관리자·센터장)은 SAL-EXT-04 "위약금 면제 권한" 정책에 따라 한정되며, 면제 사유 필수 입력으로 책임 추적이 보장됩니다.
