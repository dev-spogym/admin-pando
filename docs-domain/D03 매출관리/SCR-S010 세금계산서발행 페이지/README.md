...
슈퍼관리자(superAdmin)와 본사 최고관리자(primary)는 발행, 이메일 전송, 재발행, 엑셀 내보내기, 본사 통합 모드까지 모두 가능합니다.

센터장(owner)은 자기 지점의 발행, 이메일 전송, 재발행, 엑셀 내보내기가 가능합니다.

매니저(manager)는 발행, 이메일, 엑셀 내보내기가 가능하며 재발행은 센터장 이상 권한이 필요합니다.
