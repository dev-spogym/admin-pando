...
[소모품 등록] 버튼으로 열립니다. 본문에 품목명(필수) · 카테고리(욕실용품/청소용품/비품/기타) · 단위(개/박스/L) · 안전 재고 기준 · 초기 재고 수량 · 공급업체(선택) 입력 필드가 있습니다.
...
슈퍼관리자 · 본사 최고관리자 · 센터장(owner)은 전체 + 이력을 조회하고 등록 · 수정 · 삭제 · 입출고 · 발주 모든 기능을 사용할 수 있습니다.
...
권한별 가시성은 다음과 같이 분리됩니다. 슈퍼관리자 · 센터장은 모든 작업 가능. 매니저는 입출고 · 발주 가능, 삭제 불가. FC · 스태프는 출고 기록만 가능. 트레이너 · 읽기 전용은 조회만 가능합니다.
