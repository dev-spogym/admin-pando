...
슈퍼관리자 · 본사 최고관리자 · 센터장 · 매니저는 전체 카드 + 이력을 조회하고 등록 · 수정 · 분실 · 삭제 · 이력 조회 모든 기능을 사용할 수 있습니다. 본사 권한자만 통합 모드 조회가 가능합니다.
...
권한별 가시성은 다음과 같이 분리됩니다. 슈퍼관리자 · 센터장 · 매니저는 모든 작업이 가능합니다. FC · 스태프 · 프런트는 등록 · 분실 처리가 가능하지만 삭제는 불가능합니다. 트레이너 · 읽기 전용은 조회만 가능합니다.
