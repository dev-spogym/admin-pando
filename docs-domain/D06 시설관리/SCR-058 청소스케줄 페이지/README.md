...
슈퍼관리자 · 본사 최고관리자 · 센터장(owner)은 전체 + 이력을 조회하고 등록 · 수정 · 삭제 · 담당자 지정 · 완료 처리 모든 기능을 사용할 수 있습니다.
...
권한별 가시성은 다음과 같이 분리됩니다. 슈퍼관리자 · 센터장은 등록 · 수정 · 삭제 · 담당자 지정 · 완료. 매니저는 등록 · 완료 체크. FC · 스태프는 담당 구역 완료 체크만. 트레이너 · 읽기 전용은 조회만 가능합니다.
