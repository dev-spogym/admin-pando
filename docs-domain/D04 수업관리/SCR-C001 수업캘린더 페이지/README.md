...
본 화면에서 처리되는 강습 세션 유형 4종(PT·필라테스·스트레칭·테라피) 데이터는 SCR-D003 KPI 대시보드의 "강습세션수" 합산 원천이며 1:1로 매칭되어야 합니다. 따라서 DLG-C001에서 KPI 대상 수업을 저장할 때 강습 세션 유형 입력이 누락되지 않도록 화면 단에서 필수 검증됩니다.
