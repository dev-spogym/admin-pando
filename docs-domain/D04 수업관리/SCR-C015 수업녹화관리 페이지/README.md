...
다운로드 이력 잡은 [다운로드] 클릭 시 누가 언제 다운로드했는지 기록합니다. 무단 공유 패턴 감지 잡(매일)은 다운로드 이력을 분석해 의심 패턴을 Owner(지점장)+에게 알립니다. 모든 업로드·공유·삭제·다운로드는 SCR-097 감사 로그에 기록되고 회원앱은 webhook으로 즉시 동기화됩니다.
...
superAdmin·primary·Owner(지점장)·매니저는 전체 녹화 파일의 업로드·삭제·공유가 가능합니다. 트레이너는 본인 수업 녹화에 한해 업로드·삭제·공유가 가능합니다. FC·스태프는 접근 불가입니다. readonly는 접근 불가입니다. 회원은 회원앱에서만 본인에게 공유된 영상에 접근할 수 있습니다.
