...
슈퍼관리자·본사 최고관리자·Owner(지점장)·매니저는 전체 녹화 파일의 업로드·삭제·공유가 가능합니다. 트레이너는 본인 수업 녹화에 한해 업로드·삭제·공유가 가능합니다. FC·스태프는 접근 불가입니다. readonly는 접근 불가입니다. 회원은 회원앱에서만 본인에게 공유된 영상에 접근할 수 있습니다.
