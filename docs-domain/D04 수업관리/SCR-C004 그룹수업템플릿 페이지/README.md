...
superAdmin·primary·Owner(지점장)은 등록·수정·삭제·활성 토글을 모두 수행합니다. 매니저는 등록·수정·활성 토글이 가능하지만 삭제는 owner 이상으로 한정됩니다. 트레이너·FC·스태프는 활성 템플릿 조회만 가능합니다. readonly는 화면 접근 불가입니다. 본사 통합 정책 활성 시 슈퍼관리자·primary는 본사 표준 템플릿을 등록·수정하여 지점에 자동 동기화시킵니다.
