...
superAdmin와 primary는 모든 이벤트(본사 통합 포함)를 삭제할 수 있습니다.
...
본사 통합 이벤트는 superAdmin·primary만 삭제할 수 있으며 일반 지점 운영자는 본사 통합 이벤트를 조회만 가능하고 삭제할 수 없습니다. 본사 통합 이벤트 삭제는 전 지점에 즉시 반영됩니다.
