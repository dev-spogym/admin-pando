...
부모 화면 SCR-089의 [백업 설정] 버튼이 트리거입니다. owner와 superAdmin/primary만 호출할 수 있으며, Owner(지점장)은 자기 지점 설정만 편집 가능합니다.
...
Owner(지점장)은 자기 지점 백업 설정을 편집 가능합니다(RLS branchId 필터). primary·superAdmin은 전 지점 설정을 편집할 수 있습니다. 매니저 이하는 부모 화면 접근 자체가 차단되어 이 모달을 볼 수 없습니다.
