...
Owner(지점장)은 자기 지점의 키오스크와 IoT 장치만 관리할 수 있습니다(RLS branchId 필터). 본사 슈퍼관리자는 전 지점을 관리할 수 있습니다.
