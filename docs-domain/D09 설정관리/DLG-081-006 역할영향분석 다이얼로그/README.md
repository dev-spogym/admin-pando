...
부모 화면 SCR-081/SCR-087에 진입 가능한 Owner(지점장)·primary·superAdmin에게 동일하게 표시됩니다. Owner(지점장)은 자기 지점 역할 영향만 조회할 수 있습니다(RLS branchId 필터).
...
Owner(지점장)은 자기 지점 역할 영향만 조회 가능합니다(RLS branchId 필터).
