...
할인 정책 삭제 확인 모달은 DLG-P104 할인정책추가수정으로 등록한 정책 메타(정책 그룹·세부 카테고리·중복 규칙)를 삭제하기 전에 최종 확인을 받는 안전 모달입니다. 연결된 할인 규칙이 있으면 삭제가 차단되며 강제 해체 또는 정책 변경 후 삭제를 권장합니다.
...
본사 슈퍼관리자(primary)와 시스템 superAdmin만 모달 진입과 삭제가 가능합니다.
