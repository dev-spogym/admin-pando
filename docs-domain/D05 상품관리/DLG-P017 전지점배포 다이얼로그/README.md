...
슈퍼관리자(superAdmin)와 본사 최고관리자(primary)에게만 SCR-P001의 "전 지점 배포" 버튼이 표시되어 모달 진입이 가능합니다. Owner(지점장)·매니저·일반 직원·FC·트레이너·readonly에게는 버튼 자체가 숨겨지고 직접 URL 우회 진입도 차단됩니다.
