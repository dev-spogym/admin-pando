...
권한이 있는 슈퍼관리자·센터장·매니저·상품 편집 권한자만 모달 진입이 가능합니다.
...
슈퍼관리자(superAdmin)·본사 최고관리자(primary)·센터장(owner)·상품 편집 권한자는 등록·수정·삭제 모두 가능합니다.
...
권한 정책은 슈퍼관리자·센터장·상품 편집 권한자는 등록·수정·삭제, 매니저는 등록·수정(삭제 제외), 일반 직원은 진입 차단입니다.
