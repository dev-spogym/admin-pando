...
이 다이얼로그는 SCR-P007 재고 관리 페이지의 행 액션에서 [출고] 버튼을 눌렀을 때 호출됩니다. 권한은 매니저·재고 관리 권한 보유 직원·Owner(지점장)·슈퍼관리자에 한정됩니다. 일반 직원은 POS 판매를 통한 자동 차감만 가능하며 수기 출고는 차단됩니다.
...
권한 정책은 매니저·재고 관리 권한 보유 직원·Owner(지점장)·슈퍼관리자에 한정됩니다. 일반 직원의 수기 출고는 차단되고 POS 자동 차감만 허용되어 임의의 재고 변동을 막습니다.
