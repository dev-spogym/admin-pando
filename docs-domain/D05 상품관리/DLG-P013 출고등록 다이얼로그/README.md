...
이 다이얼로그는 SCR-P007 재고 관리 페이지의 행 액션에서 [출고] 버튼을 눌렀을 때 호출됩니다. 권한은 매니저·Owner(지점장) / manager / 재고 관리 권한을 별도 부여받은 fc·trainer·staff·Owner(지점장)·슈퍼관리자에 한정됩니다. 일반 직원은 POS 판매를 통한 자동 차감만 가능하며 수기 출고는 차단됩니다.
...
이 다이얼로그는 매니저 이상 또는 Owner(지점장) / manager / 재고 관리 권한을 별도 부여받은 fc·trainer·staff에 한정됩니다.

슈퍼관리자, 본사 최고관리자, Owner(지점장), 매니저는 출고 등록을 자유롭게 수행할 수 있습니다.

Owner(지점장) / manager / 재고 관리 권한을 별도 부여받은 fc·trainer·staff도 출고 등록이 가능합니다.
...
폐기·분실 사유는 일부 테넌트에서 Owner(지점장) 이상 권한으로 추가 제한될 수 있습니다. 그 경우 매니저에게는 사유 라디오에서 폐기·분실 옵션이 회색 비활성으로 표시됩니다.
...
권한 정책은 매니저·Owner(지점장) / manager / 재고 관리 권한을 별도 부여받은 fc·trainer·staff·Owner(지점장)·슈퍼관리자에 한정됩니다. 일반 직원의 수기 출고는 차단되고 POS 자동 차감만 허용되어 임의의 재고 변동을 막습니다.
