...
권한별 알림 범위 정책은 사용자의 역할을 기준으로 백엔드에서 자동으로 좁혀집니다. 슈퍼관리자·본사 최고관리자는 전사 또는 브랜드 단위, Owner(지점장)·매니저는 소속 지점, FC·트레이너는 본인 담당, 스태프·프런트는 출석·회원, readonly는 조회 전용 알림으로 한정됩니다.
