...
본사 superAdmin · primary · Owner(지점장) · 매니저(manager)는 이 모달을 호출하고 저장할 수 있습니다. 매니저+ 권한이 모두 동일한 UX를 경험합니다. 본사 권한자는 본사 통합 모드에서 다른 지점 직원 급여도 편집할 수 있으며, Owner(지점장)·매니저는 자기 지점 직원 급여만 편집합니다.
