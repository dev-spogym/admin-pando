...
const SCENARIOS = [
  ...
  { id: 'X09', file: 'x09-kpi-report', name: 'KPI 롤업 및 주간 리포트' },
  { id: 'X10', file: 'x10-auto-message', name: '리드유입 자동메시지' },
  ...
  { id: 'X18', file: 'x18-installment', name: '할부 결제 처리' },
  { id: 'X19', file: 'x19-member-transfer', name: '회원 이관 타지점 승인' },
  ...
  { id: 'X27', file: 'x27-class-signature', name: '수업 서명 횟수 차감' },
