...
```mermaid
flowchart TD
    DLG_001[DLG-001 로그아웃 확인] -->|E_M3_D001_01| ACTION{사용자 액션}

    ACTION -->|"E_M3_D001_02: 확인"| LOGOUT_API[로그아웃 API 호출]
    ACTION -->|"E_M3_D001_03: 취소"| RESULT_CANCEL[현재 화면 유지\n모달 닫힘]

    LOGOUT_API -->|"E_M3_D001_04: 성공"| RESULT_OK[세션 클리어\nSCR-100 이동\n완료 토스트]
    LOGOUT_API -->|"E_M3_D001_05: 실패 (무시)"| RESULT_FORCE[강제 클리어\nSCR-100 이동]
