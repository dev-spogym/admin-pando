...
platforms:
  ...
  - tablet
  - mobile
filePath: src/components/dialogs/SaleDetailDialog.tsx
diagrams:
  - docs/다이어그램/D03_매출관리/DLG-S001_매출상세/M1_모달생명주기.md
  - docs/다이어그램/D03_매출관리/DLG-S001_매출상세/M2_필드검증.md
  - docs/다이어그램/D03_매출관리/DLG-S001_매출상세/M3_결과분기.md
...
functional:
  - id: F-DS001-01
    title: '매출 데이터의 결제 정보, 카드 정보, 서비스(일수/횟수/포인트),…'
    description: '매출 데이터의 결제 정보, 카드 정보, 서비스(일수/횟수/포인트), 메모를 상/하 섹션으로 구조화.'
  - id: F-DS001-02
    title: 미수금 존재 시 시각적 경고(빨간 강조)
    description: 미수금 존재 시 시각적 경고(빨간 강조).
  - id: F-DS001-03
    title: 환불된 매출은 배지만 노출하고 "결제 취소" 버튼을 비활성화
    description: 환불된 매출은 배지만 노출하고 "결제 취소" 버튼을 비활성화.
---
