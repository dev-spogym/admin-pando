...
platforms:
  ...
  - tablet
  - mobile
route: '/staff/resignation?staffId={id}'
filePath: src/app/staff/resignation/page.tsx
component: StaffResignationPage
diagrams:
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F1_진입.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F2_메인인터랙션.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F3_버튼액션.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F6_상태별화면.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F7_권한분기.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F8_에러예외복구.md
  - docs/다이어그램/D07_직원관리/SCR-062_직원퇴사처리/F9_토스트피드백.md
errorCodes:
  - E400001
  - E404200
  - E409200
...
functional:
  - id: F-062-01
    title: Step 1
    description: 'Step 1: 대상 직원·퇴사 예정일·사유 입력.'
  - id: F-062-02
    title: Step 2
    description: 'Step 2: **FC 직원인 경우**, 담당 회원을 다른 FC로 재배정.'
  - id: F-062-03
    title: Step 3
    description: 'Step 3: 퇴사 예정일 이후 예약된 미래 스케줄 확인(이관/취소 선택).'
  - id: F-062-04
    title: Step 4
    description: 'Step 4: 최종 요약 검토 후 퇴사 예정 등록.'
  - id: F-062-05
    title: 담당 회원 재배정
    description: 담당 회원 재배정 → 퇴사 등록 API 순차 호출.
---
