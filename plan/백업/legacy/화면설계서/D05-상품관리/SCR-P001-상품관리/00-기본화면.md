...
diagrams:
  ...
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F2_메인인터랙션.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F3_버튼액션.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F4_필터검색정렬.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F5_모달트리거.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F6_상태별화면.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F7_권한RBAC.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F8_에러예외복구.md
  - docs/다이어그램/D05_상품관리/SCR-P001_상품관리/F9_토스트피드백.md
errorCodes:
  - E409001
  - E500001
  - E500002
...
functional:
  - id: F-P001-01
    title: '좌측 테이블 = 마스터, 우측 ProductDetailPanel =…'
    description: '좌측 테이블 = 마스터, 우측 ProductDetailPanel = 상세/등록/수정 (SCR-P003).'
  - id: F-P001-02
    title: 3단 필터(타입
    description: 3단 필터(타입 → 카테고리 → 종목) + 검색으로 대량 상품을 빠르게 탐색.
  - id: F-P001-03
    title: 최상위 탭에서 상품 목록 ↔ 분류 관리(product_groups) 전환
    description: 최상위 탭에서 **상품 목록** ↔ **분류 관리**(product_groups) 전환.
  - id: F-P001-04
    title: '슈퍼관리자는 전 지점 배포, 브랜드 소유자는 지점 간 복제, 그 외…'
    description: '슈퍼관리자는 **전 지점 배포**, 브랜드 소유자는 **지점 간 복제**, 그 외 역할은 조회 중심.'
---
