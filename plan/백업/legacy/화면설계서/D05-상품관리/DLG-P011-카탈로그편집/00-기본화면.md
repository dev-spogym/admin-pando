...
roles:
  ...
  - manager
  - 기타
filePath: src/components/dialogs/CatalogEditDialog.tsx
diagrams:
  - docs/다이어그램/D05_상품관리/DLG/DLG-P011_카탈로그편집/M1_모달생명주기.md
  - docs/다이어그램/D05_상품관리/DLG/DLG-P011_카탈로그편집/M2_필드검증.md
  - docs/다이어그램/D05_상품관리/DLG/DLG-P011_카탈로그편집/M3_결과분기.md
errorCodes:
  - E400001
  - E400302
  - E403001
...
functional:
  - id: F-DP011-01
    title: '상품의 CRM 기본 정보와 별도로, 고객 노출용 콘텐츠(이미지/카피/…'
    description: '상품의 CRM 기본 정보와 별도로, **고객 노출용 콘텐츠(이미지/카피/혜택)**을 편집한다.'
  - id: F-DP011-02
    title: 카탈로그 카드에서 즉시 접근하여 빠르게 이미지/설명을 갱신
    description: 카탈로그 카드에서 즉시 접근하여 빠르게 이미지/설명을 갱신.
  - id: F-DP011-03
    title: '공개/비공개 토글과 catalogOrder는 카드 드래그에서, 콘텐츠…'
    description: '공개/비공개 토글과 `catalogOrder`는 카드 드래그에서, 콘텐츠는 본 모달에서 담당.'
---
