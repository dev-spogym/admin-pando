...
functional:
  - id: F-C006-01
    title: 5개 StatCards(총 강사/총 수업/총 근무시간/평균 출석률/평…
    description: 5개 StatCards(총 강사/총 수업/총 근무시간/평균 출석률/평균 노쇼율)
  - id: F-C006-02
    title: 기간 필터(이번 달/지난달/커스텀)
    description: 기간 필터(이번 달/지난달/커스텀)
  - id: F-C006-03
    title: 강사 카드 그리드(sm
    description: '강사 카드 그리드(sm:2, lg:3, xl:4)에서 카드 클릭 → DLG-C010 상세.'
  - id: F-C006-04
    title: '트레이너는 본인 카드만, manager 이상 전체 노출'
    description: '트레이너는 본인 카드만, manager 이상 전체 노출.'
---
