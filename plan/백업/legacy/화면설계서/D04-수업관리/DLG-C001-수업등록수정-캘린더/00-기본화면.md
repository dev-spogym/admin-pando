...
roles:
  ...
  - fc
  - trainer
filePath: src/components/classes/LessonCalendarModal.tsx
diagrams:
  - docs/다이어그램/D04_수업관리/DLG/DLG-C001_수업등록수정_캘린더/M1_생명주기.md
  - docs/다이어그램/D04_수업관리/DLG/DLG-C001_수업등록수정_캘린더/M2_필드검증.md
  - docs/다이어그램/D04_수업관리/DLG/DLG-C001_수업등록수정_캘린더/M3_결과분기.md
...
functional:
  - id: F-DC001-01
    title: 기본 정보(수업명·유형·강사·정원·날짜·시간·장소)
    description: 기본 정보(수업명·유형·강사·정원·날짜·시간·장소)
  - id: F-DC001-02
    title: 예약 오픈 설정(FN-034
    description: '예약 오픈 설정(FN-034: 최대 예약 인원, 예약 마감일)'
  - id: F-DC001-03
    title: 좌석 배치(FN-037
    description: '좌석 배치(FN-037: 행×열 그리드)'
  - id: F-DC001-04
    title: 일정 분류(#17
    description: '일정 분류(#17: 상담/OT/체성분/방문/수업/PT/기타)'
  - id: F-DC001-05
    title: 대상(#16
    description: '대상(#16: 회원/비회원/직원)'
  - id: F-DC001-06
    title: 참여자 목록(검색 기반 추가)
    description: 참여자 목록(검색 기반 추가)
  - id: F-DC001-07
    title: '수업 색상(10색 팔레트), 메모'
    description: '수업 색상(10색 팔레트), 메모'
  - id: F-DC001-08
    title: 저장 시 동일 강사 시간 충돌 검사
    description: 저장 시 **동일 강사 시간 충돌 검사** → confirm 후 진행.
---
