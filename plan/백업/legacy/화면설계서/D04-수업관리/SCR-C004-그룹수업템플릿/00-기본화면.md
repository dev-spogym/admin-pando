...
filePath: src/app/(classes)/class-templates/page.tsx
component: ClassTemplatesPage
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F1_진입.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F2_메인.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F3_버튼액션.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F4_필터검색.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F5_모달트리거.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F6_상태별.md
  - docs/다이어그램/D04_수업관리/SCR-C004_그룹수업템플릿/F7_권한.md
errorCodes:
  - E400500
  - E404500
  - E409000
...
functional:
  - id: F-C004-01
    title: SCR-C003 시간표 일괄 등록에서 템플릿 선택만으로 프리필
    description: '**SCR-C003 시간표 일괄 등록**에서 템플릿 선택만으로 프리필.'
  - id: F-C004-02
    title: SCR-C001 수업 캘린더에서 빠른 수업 등록에 활용
    description: '**SCR-C001 수업 캘린더**에서 빠른 수업 등록에 활용.'
  - id: F-C004-03
    title: 반복 수업 구조의 일관성 유지 및 휴먼 에러 감소
    description: 반복 수업 구조의 일관성 유지 및 휴먼 에러 감소.
---
