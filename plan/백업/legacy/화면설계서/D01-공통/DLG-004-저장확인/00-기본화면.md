...
diagrams:
  - docs/다이어그램/D01_공통/DLG/DLG-004_저장확인/M1_생명주기.md
errorCodes:
  - E400001
  - E401002
  - E403001
...
functional:
  - id: F-D004-01
    title: 주요 설정 저장 직전 한 번 더 의도 확인
    description: 주요 설정 저장 직전 한 번 더 의도 확인.
  - id: F-D004-02
    title: 저장 중/성공/실패/충돌의 결과 UI를 하나의 모달에서 흐름 있게 처리
    description: 저장 중/성공/실패/충돌의 결과 UI를 하나의 모달에서 흐름 있게 처리.
  - id: F-D004-03
    title: 낙관적 잠금 충돌(E409xxx) 시 최신 데이터 재로드 또는 사용자…
    description: 낙관적 잠금 충돌(`E409xxx`) 시 최신 데이터 재로드 또는 사용자 입력 유지 중 선택.
---
