...
platforms:
  ...
  - mobile
route: /leads
filePath: src/app/(dashboard)/leads/page.tsx
component: LeadsPage
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F1_진입.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F2_메인인터랙션.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F3_버튼액션.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F4_필터검색.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F5_모달트리거.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F6_상태별화면.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F7_권한분기.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F8_에러예외.md
  - docs/다이어그램/D08_마케팅/SCR-070_리드관리/F9_토스트피드백.md
errorCodes:
  - E401000
  - E403001
  - E500001
...
functional:
  - id: F-070-01
    title: 프리-온보딩 단계의 첫 접점
    description: '프리-온보딩 단계의 **첫 접점**: FC가 리드를 등록하고 상태를 전진시켜 매출로 연결.'
  - id: F-070-02
    title: 리드 응대 시간(24시간 이내) 및 리드 누락률(3% 이하) KPI…
    description: 리드 응대 시간(24시간 이내) 및 리드 누락률(3% 이하) KPI 모니터링.
  - id: F-070-03
    title: convertedMemberId 채워지면 회원 상세(/members/…
    description: '`convertedMemberId` 채워지면 회원 상세(`/members/detail?id=...`)로 연결 가능.'
---
