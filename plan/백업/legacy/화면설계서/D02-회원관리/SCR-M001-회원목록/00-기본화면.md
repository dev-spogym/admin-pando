...
platforms:
  ...
  - mobile
route: /members
filePath: src/app/(dashboard)/members/page.tsx
component: MembersPage
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F1_진입.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F2_메인.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F3_버튼액션.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F5_모달트리거.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F6_상태별.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F7_권한.md
  - docs/다이어그램/D02_회원관리/SCR-M001_회원목록/F8_에러.md
errorCodes:
  - E401001
  - E401002
  - E403001
...
functional:
  - id: F-M001-01
    title: FC가 오늘 만료 예정 회원을 검색하여 리텐션 상담
    description: FC가 오늘 만료 예정 회원을 검색하여 리텐션 상담
  - id: F-M001-02
    title: 매니저가 30일 이상 미방문 회원에게 일괄 메시지 발송
    description: 매니저가 30일 이상 미방문 회원에게 일괄 메시지 발송
  - id: F-M001-03
    title: 센터장이 전체 회원 엑셀 다운로드
    description: 센터장이 전체 회원 엑셀 다운로드
---
