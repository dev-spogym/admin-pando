...
domain: D02-회원관리
title: 상담 등록
parentRoutes: [/members/detail]
filePath: src/components/member/dialogs/ConsultationFormDialog.tsx
component: ConsultationFormDialog
priority: P0
roles: [primary, owner, manager, fc]
platforms: [desktop, tablet]
functional:
  - id: F-DM011-01
    title: 상담 이력 등록/수정 통합 폼
    description: 추가와 수정을 단일 다이얼로그로 처리(editTarget 주입 시 수정 모드).
  - id: F-DM011-02
    title: 표준 메타 수집
    description: 상담 일시·유형·채널·상태·결과·후속조치·연결 매출 등 funnel 분석용 메타 일괄 입력.
  - id: F-DM011-03
    title: 상담 파이프라인 운영
    description: 상태=예정 + 후속조치 플래그로 재연락 큐 관리. 대시보드에서 기한 임박 상담을 자동 노출.
  - id: F-DM011-04
    title: 연결 매출·리드 매칭
    description: 회원번호·전화번호 기반으로 기존 리드와 자동 매칭, 상담→등록 전환 funnel 지표 자동 산출.
diagrams:
  - docs/다이어그램/D02_회원관리/DLG/DLG-M011_상담등록/M1_생명주기.md
  - docs/다이어그램/D02_회원관리/DLG/DLG-M011_상담등록/M2_필드검증.md
  - docs/다이어그램/D02_회원관리/DLG/DLG-M011_상담등록/M3_결과분기.md
errorCodes: [E400001, E404100]
---
