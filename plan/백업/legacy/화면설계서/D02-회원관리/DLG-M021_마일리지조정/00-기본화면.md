...
functional:
  - id: F-DM021-01
    title: 사유 필수 입력
    description: 사유 필수 입력 → 감사로그 기록
  - id: F-DM021-02
    title: 포인트 부족 시 USE 차단
    description: 포인트 부족 시 USE 차단
  - id: F-DM021-03
    title: 성공 시 member_mileage_logs 테이블에 이력 저장 +…
    description: 성공 시 `member_mileage_logs` 테이블에 이력 저장 + 회원 잔액 갱신
---
