...
functional:
  - id: F-DM022-01
    title: 단일 버튼 클릭
    description: 단일 버튼 클릭 → 즉시 서버 호출 → 성공/실패 토스트
  - id: F-DM022-02
    title: 별도 입력 폼 없음
    description: '별도 입력 폼 없음: 현재 시각(`now()`) + 현재 지점(`branchId`) + 수동 마크'
  - id: F-DM022-03
    title: 당일 중복 출석 방지 (E403400)
    description: 당일 중복 출석 방지 (E403400)
  - id: F-DM022-04
    title: 영업시간 외 차단 (E403401)
    description: 영업시간 외 차단 (E403401)
---
