...
roles:
  ...
  - manager
  - front
filePath: src/components/rfid/CardModal.tsx
diagrams:
  - docs/다이어그램/D06_시설관리/DLG/DLG-052-001_RFID등록수정/M1_생명주기.md
  - docs/다이어그램/D06_시설관리/DLG/DLG-052-001_RFID등록수정/M2_필드검증.md
  - docs/다이어그램/D06_시설관리/DLG/DLG-052-001_RFID등록수정/M3_결과분기.md
...
functional:
  - id: F-D052-001-01
    title: 스캔 입력과 수동 입력 듀얼 모드 — 하드웨어 리더 유무에 무관한 운…
    description: 스캔 입력과 수동 입력 **듀얼 모드** — 하드웨어 리더 유무에 무관한 운영 가능
  - id: F-D052-001-02
    title: 회원/직원 두 유형의 사용자 매핑을 단일 폼에서 분기 처리
    description: 회원/직원 두 유형의 사용자 매핑을 단일 폼에서 분기 처리
  - id: F-D052-001-03
    title: 중복 카드번호 서버 검증 + 인라인 에러로 즉시 피드백
    description: 중복 카드번호 서버 검증 + 인라인 에러로 즉시 피드백
---
