...
platforms:
  ...
  - tablet
route: /rfid
filePath: src/app/(facilities)/rfid/page.tsx
component: RfidManagement
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F1_진입.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F2_메인.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F3_버튼액션.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F5_모달트리거.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F6_상태별.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F7_권한.md
  - docs/다이어그램/D06_시설관리/SCR-052_밴드카드관리/F8_에러.md
errorCodes:
  - E401001
  - E404600
  - E409600
...
functional:
  - id: F-052-01
    title: 카드 스캔(USB/시리얼/시뮬) + 수동 입력 모두 지원
    description: 카드 스캔(USB/시리얼/시뮬) + 수동 입력 모두 지원
  - id: F-052-02
    title: 회원/직원 매핑 + 사물함 번호 연결
    description: 회원/직원 매핑 + 사물함 번호 연결
  - id: F-052-03
    title: 분실·해제 상태 관리 + 이력 조회
    description: 분실·해제 상태 관리 + 이력 조회
  - id: F-052-04
    title: 카드번호 UNIQUE 제약(E409601) 강제
    description: 카드번호 UNIQUE 제약(E409601) 강제
---
