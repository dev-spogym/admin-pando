...
functional:
  - id: F-D050-001-01
    title: 회원 분실/민원 대응 시 언제 누가 무슨 작업을 했는지 근거 제시
    description: 회원 분실/민원 대응 시 **언제 누가 무슨 작업을 했는지** 근거 제시
  - id: F-D050-001-02
    title: 해당 락커의 현재 비밀번호/메모(있을 경우) 확인
    description: 해당 락커의 **현재 비밀번호/메모**(있을 경우) 확인
  - id: F-D050-001-03
    title: 장기 미사용·반복 고장 락커의 패턴 식별
    description: 장기 미사용·반복 고장 락커의 **패턴 식별**
  - id: F-D050-001-04
    title: 내부 감사 추적(오남용 점검)
    description: 내부 **감사 추적**(오남용 점검)
---
