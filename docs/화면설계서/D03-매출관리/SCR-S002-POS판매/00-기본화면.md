...
functional:
  - id: F-S002-01
    title: 피트니스 센터 프론트 데스크 현장 판매를 위한 터치 친화적 UI
    description: 피트니스 센터 프론트 데스크 현장 판매를 위한 터치 친화적 UI
  - id: F-S002-02
    title: 상품 카드 클릭 한 번으로 장바구니 담기
    description: 상품 카드 클릭 한 번으로 장바구니 담기
  - id: F-S002-03
    title: 회원 검색
    description: 회원 검색 → 구매자 지정 (마일리지 결제 준비)
  - id: F-S002-04
    title: 결제 페이지(SCR-S003)로 sessionStorage 경유 데이…
    description: 결제 페이지(`SCR-S003`)로 `sessionStorage` 경유 데이터 전달
---
