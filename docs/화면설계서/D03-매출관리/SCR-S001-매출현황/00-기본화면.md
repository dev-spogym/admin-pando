...
functional:
  - id: F-S001-01
    title: 기간/상품/결제수단/담당자별 집계를 탭 단위로 제공 (7개 탭)
    description: 기간/상품/결제수단/담당자별 집계를 탭 단위로 제공 (7개 탭)
  - id: F-S001-02
    title: 환불·미납 내역을 별도 탭으로 분리하여 건전성 모니터링
    description: 환불·미납 내역을 별도 탭으로 분리하여 건전성 모니터링
  - id: F-S001-03
    title: 'POS 신규 결제, 엑셀 내보내기, 매출 상세 팝업의 허브 역할'
    description: 'POS 신규 결제, 엑셀 내보내기, 매출 상세 팝업의 허브 역할'
  - id: F-S001-04
    title: '트레이너는 본인 담당만, FC는 POS 버튼만, 매니저 이상은 전체…'
    description: '트레이너는 본인 담당만, FC는 POS 버튼만, 매니저 이상은 전체 분석 — **권한별 뷰 차등** 필수'
---
