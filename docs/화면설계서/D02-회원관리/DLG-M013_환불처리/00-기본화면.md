...
roles:
  ...
  - owner
  - manager
filePath: src/components/member/dialogs/RefundDialog.tsx
diagrams:
  - docs/다이어그램/D02_회원관리/DLG/DLG-M013_환불처리/M1_생명주기.md
errorCodes:
  - E400301
  - E403001
  - E404300
...
functional:
  - id: F-DM013-01
    title: 부분 반환 없는 전체 환불
    description: '**부분 반환 없는 전체 환불**: 단건 결제 전체 금액을 환불 처리(단순 정책).'
  - id: F-DM013-02
    title: 이중 레코드 구조
    description: '**이중 레코드 구조**: 음수 환불 행 INSERT + 원본 `status=''REFUNDED''` UPDATE (감사/정산 유지).'
  - id: F-DM013-03
    title: 승인 레벨 강제
    description: '**승인 레벨 강제**: fc/staff 진입 차단 (manager 이상).'
  - id: F-DM013-04
    title: 매출 재집계 트리거
    description: '**매출 재집계 트리거**: 성공 시 D03 매출 대시보드/월간 리포트 invalidate.'
---
