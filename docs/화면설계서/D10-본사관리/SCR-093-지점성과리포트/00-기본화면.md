...
platforms:
  - desktop
route: /branch-report
filePath: src/app/(admin)/branch-report/page.tsx
...
functional:
  - id: F-093-01
    title: "매출 기준 1~3위 메달 표시 (\U0001F947\U0001F948\U0001F949), 4위+ 숫자"
    description: "매출 기준 1~3위 메달 표시 (\U0001F947\U0001F948\U0001F949), 4위+ 숫자"
  - id: F-093-02
    title: 총회원·신규·활성·만료·매출·객단가·출석률 8개 지표 비교
    description: 총회원·신규·활성·만료·매출·객단가·출석률 8개 지표 비교
  - id: F-093-03
    title: 지점별 매출/회원 가로 바 차트로 시각화
    description: 지점별 매출/회원 가로 바 차트로 시각화
  - id: F-093-04
    title: '월 선택, 정렬, 엑셀 다운로드 지원'
    description: '월 선택, 정렬, 엑셀 다운로드 지원'
---
