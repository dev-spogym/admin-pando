...
roles:
  ...
  - manager
route: /kpi
filePath: src/app/(admin)/kpi/page.tsx
...
functional:
  - id: F-094-01
    title: '회원 현황 6개, 매출 4개 + 달성률 게이지, 상담/전환 4개, P…'
    description: '회원 현황 6개, 매출 4개 + 달성률 게이지, 상담/전환 4개, PT 4개, GX 4개'
  - id: F-094-02
    title: '코호트 분석 (최근 6개월 유지율), 퍼널 분석 (리드'
    description: '코호트 분석 (최근 6개월 유지율), 퍼널 분석 (리드→재등록 5단계)'
  - id: F-094-03
    title: '지점별 집계 (manager=본인 지점, primary/owner=전체)'
    description: '지점별 집계 (manager=본인 지점, primary/owner=전체)'
  - id: F-094-04
    title: 매출 목표 저장 (localStorage kpi_monthly_tar…
    description: '매출 목표 저장 (localStorage `kpi_monthly_target_{branchId}_{yearMonth}`)'
---
