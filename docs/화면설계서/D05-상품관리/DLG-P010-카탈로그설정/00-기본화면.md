...
roles:
  ...
  - manager
  - 나머지
filePath: src/components/dialogs/CatalogSettingsDialog.tsx
diagrams:
  - docs/다이어그램/D05_상품관리/DLG/DLG-P010_카탈로그설정/M1_모달생명주기.md
  - docs/다이어그램/D05_상품관리/DLG/DLG-P010_카탈로그설정/M2_필드검증.md
  - docs/다이어그램/D05_상품관리/DLG/DLG-P010_카탈로그설정/M3_결과분기.md
...
functional:
  - id: F-DP010-01
    title: 회원 앱/키오스크/공개 카탈로그 페이지의 지점 브랜딩 설정을 일괄 관…
    description: 회원 앱/키오스크/공개 카탈로그 페이지의 **지점 브랜딩 설정**을 일괄 관리한다.
  - id: F-DP010-02
    title: 로고/테마색/문의 전화 등 고객 접점 메타 정보를 중앙화하여 일관된…
    description: 로고/테마색/문의 전화 등 고객 접점 메타 정보를 중앙화하여 일관된 체험 제공.
  - id: F-DP010-03
    title: '가격 표시 on/off, 온라인 결제 링크 노출 등 영업 정책 토글 제공'
    description: '가격 표시 on/off, 온라인 결제 링크 노출 등 **영업 정책 토글** 제공.'
---
