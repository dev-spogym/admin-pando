...
filePath: src/app/(main)/settings/kiosk/page.tsx
component: KioskSettingsPage
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F1_진입.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F2_메인인터랙션.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F3_버튼액션.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F5_모달트리거.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F6_상태별화면.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F7_권한RBAC.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F8_에러예외복구.md
  - docs/다이어그램/D09_설정관리/SCR-082_키오스크설정/F9_토스트피드백.md
errorCodes:
  - E401001
  - E403001
  - E500001
...
functional:
  - id: F-082-01
    title: 4개 탭(기본설정/화면설정/TTS설정/출입규칙)으로 역할 분리
    description: 4개 탭(기본설정/화면설정/TTS설정/출입규칙)으로 역할 분리.
  - id: F-082-02
    title: 우측에 실시간 미리보기(KioskPreview) 제공 — 환영 문구/…
    description: 우측에 **실시간 미리보기(KioskPreview)** 제공 — 환영 문구/테마색/공지/배너 즉시 반영.
  - id: F-082-03
    title: 저장 시 D11 통합운영 서비스로 push(MQTT/HTTP)되어 현…
    description: 저장 시 D11 통합운영 서비스로 push(MQTT/HTTP)되어 현장 키오스크 기기에 실시간 반영. D11 OFF면 경고 배너.
  - id: F-082-04
    title: 얼굴 인식(face) 체크인 활성화 시 추가 섹션(인식 모드/민감도/…
    description: 얼굴 인식(face) 체크인 활성화 시 추가 섹션(인식 모드/민감도/병행 인증/자동 등록)이 동적 확장.
---
