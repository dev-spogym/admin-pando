...
roles:
  ...
  - owner
  - manager
filePath: src/components/settings/UnsavedWarningDialog.tsx
diagrams:
  - docs/다이어그램/D09_설정관리/DLG/DLG-080-001_미저장경고/M1_생명주기.md
errorCodes:
  - E401002
  - E403001
  - E403003
...
functional:
  - id: F-D080-001-01
    title: 기본정보/알림/테마/물품 4개 탭을 편집 중 실수로 탭 이동 또는 페…
    description: 기본정보/알림/테마/물품 4개 탭을 편집 중 실수로 탭 이동 또는 페이지 이탈 시 변경 소실 방지
  - id: F-D080-001-02
    title: '"저장 후 이동" 액션을 통해 의도적 이동 경로 제공'
    description: '"저장 후 이동" 액션을 통해 의도적 이동 경로 제공'
  - id: F-D080-001-03
    title: '사이드바의 다른 설정(권한, 키오스크, IoT 등) 클릭 시에도 동일…'
    description: '사이드바의 다른 설정(권한, 키오스크, IoT 등) 클릭 시에도 동일하게 경고'
---
