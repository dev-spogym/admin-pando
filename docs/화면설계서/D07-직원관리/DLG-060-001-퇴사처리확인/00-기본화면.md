...
roles:
  - superAdmin
  - owner
filePath: src/components/staff/ResignConfirmDialog.tsx
component: ConfirmDialog
diagrams:
  - docs/다이어그램/D07_직원관리/DLG/DLG-060-001/M1_모달생명주기.md
  - docs/다이어그램/D07_직원관리/DLG/DLG-060-001/M2_필드검증.md
  - docs/다이어그램/D07_직원관리/DLG/DLG-060-001/M3_결과분기.md
...
functional:
  - id: F-D060-001-01
    title: 텍스트 타이핑 확인
    description: '**텍스트 타이핑 확인**: `"퇴사처리"` 정확 일치'
  - id: F-D060-001-02
    title: 권한 확인
    description: '**권한 확인**: `role ∈ {superAdmin, owner}`'
---
