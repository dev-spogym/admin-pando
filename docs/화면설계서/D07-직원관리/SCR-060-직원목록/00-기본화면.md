...
diagrams:
  ...
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F1_진입.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F2_메인인터랙션.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F3_버튼액션.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F4_필터검색정렬.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F5_모달트리거.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F6_상태별화면.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F7_권한분기.md
  - docs/다이어그램/D07_직원관리/SCR-060_직원목록/F8_에러예외복구.md
...
functional:
  - id: F-060-01
    title: 4개 통계 카드(전체/재직/휴직/퇴사)로 인력 현황 즉시 파악
    description: 4개 통계 카드(전체/재직/휴직/퇴사)로 인력 현황 즉시 파악.
  - id: F-060-02
    title: 이름·연락처 검색 + 역할·상태 필터 + 3-state 정렬로 빠른 탐색
    description: 이름·연락처 검색 + 역할·상태 필터 + 3-state 정렬로 빠른 탐색.
  - id: F-060-03
    title: 다중 선택 후 메시지 전송 / 상태 변경(DLG-060-002) /…
    description: 다중 선택 후 메시지 전송 / 상태 변경(DLG-060-002) / 퇴사 처리(DLG-060-001) 일괄 수행.
  - id: F-060-04
    title: 엑셀 다운로드로 외부 보고용 명단 추출
    description: 엑셀 다운로드로 외부 보고용 명단 추출.
  - id: F-060-05
    title: 멀티테넌트
    description: '멀티테넌트: 자기 지점만(owner), 슈퍼/최고관리자는 지점 전환 가능.'
---
