...
filePath: src/app/(classes)/schedule-requests/page.tsx
component: ScheduleRequestsPage
diagrams:
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F1_진입.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F2_메인.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F3_버튼액션.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F4_필터검색.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F5_모달트리거.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F6_상태별.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F7_권한.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F8_에러.md
  - docs/다이어그램/D04_수업관리/SCR-C009_일정요청처리/F9_토스트.md
...
functional:
  - id: F-C009-01
    title: 매일 오전 운영 루틴의 1차 관문 — 미승인 건이 쌓이면 회원 앱 U…
    description: 매일 오전 운영 루틴의 1차 관문 — 미승인 건이 쌓이면 회원 앱 UX가 훼손되므로 SLA(당일 처리)가 부여됨.
  - id: F-C009-02
    title: '트레이너는 본인 대상 요청만 처리하며, 매니저/프론트는 지점 내 전체…'
    description: '트레이너는 **본인 대상** 요청만 처리하며, 매니저/프론트는 지점 내 전체를 처리한다.'
  - id: F-C009-03
    title: '대안 일정 제시는 거절과 승인의 중간 경로로, 회원-직원 간 일정 조…'
    description: '대안 일정 제시는 거절과 승인의 중간 경로로, 회원-직원 간 일정 조율을 유연화한다.'
---
