...
functional:
  - id: F-C003-01
    title: 좌측 폼 + 우측 미리보기 2열 레이아웃
    description: '**좌측 폼** + **우측 미리보기** 2열 레이아웃.'
  - id: F-C003-02
    title: 미리보기 단계에서 생성 예정 수업 건수/일자를 확인 후 DLG-C00…
    description: 미리보기 단계에서 생성 예정 수업 건수/일자를 확인 후 DLG-C008 확인 → 서버 bulk INSERT.
  - id: F-C003-03
    title: '시간 충돌(E400501)은 사전 미리보기에서 경고하고, 서버에서 재검증'
    description: '시간 충돌(E400501)은 사전 미리보기에서 경고하고, 서버에서 재검증.'
  - id: F-C003-04
    title: 멀티테넌트
    description: '멀티테넌트: `branchId` 강제, super/primary만 지점 전환 가능.'
---
