...
platforms:
  ...
  - tablet
route: /class-stats
filePath: src/app/(classes)/class-stats/page.tsx
component: ClassStatsPage
diagrams:
  - docs/다이어그램/10_권한매트릭스/R1_역할화면_매트릭스.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F1_진입.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F2_메인.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F3_버튼액션.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F4_필터검색.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F6_상태별.md
  - docs/다이어그램/D04_수업관리/SCR-C005_그룹수업현황/F7_권한.md
errorCodes:
  - E404500
  - E500001
  - E503001
functional:
  - id: F-C005-01
    title: 5개 StatCards(총수업/총예약/총출석/평균예약률/평균출석률)
    description: 5개 StatCards(총수업/총예약/총출석/평균예약률/평균출석률)
  - id: F-C005-02
    title: 기간 필터(이번 주/이번 달/이번 분기) + 월별 트렌드 바 차트(최…
    description: 기간 필터(이번 주/이번 달/이번 분기) + 월별 트렌드 바 차트(최근 6개월)
  - id: F-C005-03
    title: 수업별 예약률·출석률 테이블(프로그레스 바 색상 코딩)
    description: 수업별 예약률·출석률 테이블(프로그레스 바 색상 코딩)
  - id: F-C005-04
    title: 'trainer는 본인 수업만, manager 이상은 지점 전체, su…'
    description: 'trainer는 본인 수업만, manager 이상은 지점 전체, super/primary는 지점 전환.'
---
