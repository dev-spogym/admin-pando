...
flowchart LR
    User([접근 시도\n/admin/nps])
    User -->|E_F7_104_01| RoleCheck{역할 확인}

    RoleCheck -->|"E_F7_104_02: primary"| P[최고관리자\n전체 지점 NPS + 설문 발송]
    RoleCheck -->|"E_F7_104_03: owner"| O[센터장\n본인 지점 NPS + 설문 발송]
    RoleCheck -->|"E_F7_104_04: manager/fc/staff"| Staff[403 접근 차단\n권한 없음 토스트]
    RoleCheck -->|"E_F7_104_05: readonly"| RO[읽기 전용\n설문 발송 버튼 숨김]
