...
> **도메인**: D11 통합운영
> **화면설계서**: `docs/화면설계서/통합운영_IOT_헬스.md`
...
|--------|--------|-----------|:---:|
| SCR-I001 | 통합 출석 관리 | `/attendance` | 9 |
| SCR-I002 | 키오스크 설정 | `/settings/kiosk` | 9 |
| SCR-I003 | IoT 연동 관리 | `/settings/iot` | 9 |
| SCR-I004 | 옷 락커 운영 관리 | `/locker` | 9 |
| SCR-I005 | 고정 물품 락커 관리 | `/locker/management` | 9 |
| SCR-I006 | 체성분 통합 관리 | `/body-composition` | 9 |
| SCR-I007 | 회원 상세 건강/연동 요약 | `/members/detail` | 9 |
...
|--------|--------|-----------|:---:|
| DLG-I001 | 수동 출석 등록 | SCR-I001 | 3 |
| DLG-I002 | 옷 락커 배정 | SCR-I001, SCR-I004 | 3 |
| DLG-I003 | 체성분 수기 등록 | SCR-I006 | 3 |
