...
> **기준**: `공통.md` 2.2 메뉴 접근 매트릭스 + `설정관리.md` SCR-081
...
| 코드 | 역할키 | 한글명 | 설명 | 수정 가능 |
|------|--------|--------|------|:---:|
| R1 | `superAdmin` | 슈퍼관리자 | 본사 운영 총괄, 전 지점 접근 | ✗ |
...
> 참고: `readonly`는 설정관리.md SCR-081에 명시된 7번째 시스템 역할.
> 공통.md 메뉴 접근 매트릭스는 R1~R6 기준이며, readonly는 전 메뉴 조회만 허용.
...
| 파일 | 다이어그램 ID | 내용 |
|------|-------------|------|
| [R1_역할화면_매트릭스.md](R1_역할화면_매트릭스.md) | RBAC_R1 | 역할 × 화면 전체 접근 매트릭스 |
| [R2_primary_journey.md](R2_primary_journey.md) | RBAC_R2 | primary(최고관리자) journey |
| [R3_owner_journey.md](R3_owner_journey.md) | RBAC_R3 | owner(센터장) journey |
| [R4_manager_journey.md](R4_manager_journey.md) | RBAC_R4 | manager(매니저) journey |
| [R5_fc_journey.md](R5_fc_journey.md) | RBAC_R5 | fc(피트니스코치) journey |
| [R6_staff_journey.md](R6_staff_journey.md) | RBAC_R6 | staff(스태프) journey |
| [R7_readonly_journey.md](R7_readonly_journey.md) | RBAC_R7 | readonly(조회전용) journey |
| [R8_권한위계.md](R8_권한위계.md) | RBAC_R8 | 역할 간 권한 위계 |
