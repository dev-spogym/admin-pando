...
flowchart LR
    ...
    P & O --> FullAccess[저장 버튼 표시\n상품삭제 버튼 표시\n가격이력 버튼 표시\n기존 상품 복사 버튼 표시\n모든 필드 편집 가능]

    M --> ManagerAccess[저장 버튼 표시\n상품삭제 버튼 숨김\n가격이력 버튼 표시\n기존 상품 복사 버튼 표시\n필드 편집 가능]
...
|-------|------|-------|------|------|
| TC-P003-F7-01 | positive | manager | 패널 오픈 | 저장/가격이력/기존 상품 복사 버튼 표시, 상품삭제 버튼 숨김 |
| TC-P003-F7-02 | positive | trainer | 패널 오픈 | 저장/삭제/가격이력 버튼 숨김 |
