...
> **도메인**: D09 설정관리
> **화면설계서**: `docs/admin/화면설계서/D09-설정관리`
...
- **센터 설정 (SCR-080)**: 4개 탭(기본정보/알림/테마/물품), 상태 관리, 탭 전환 미저장 경고(DLG-080-001)
...
- **X09**: 지점→본사 KPI 롤업 (`30_시나리오_시퀀스/30-09_지점본사KPI롤업`)
- **X15**: 공지 전파 (`30_시나리오_시퀀스/30-15_공지전파`)
