...
| 출발 | 도착 | 라벨 / 조건 |
|------|------|-------------|
| 사이드바 | 권한 확인 | 사이드바 회원 목록 클릭 |
| URL 직접 접근 | 권한 확인 | / URL 진입 |
| 대시보드 위젯 | 권한 확인 | 대시보드 회원 위젯 클릭 |
| 글로벌 검색 | 권한 확인 | 검색 결과에서 회원 목록 이동 |
| KPI 센터 | 권한 확인 | KPI 회원 지표 클릭 |
| 권한 확인 | 접근 차단 | readonly 역할 → 접근 불가 |
| 권한 확인 | SCR-M001 | primary |
| SCR-M001 | 로딩 | 화면 마운트 후 데이터 요청 |
| 로딩 | 목록 표시 | API 정상 응답 |
| 로딩 | 에러 배너 | API 오류 |
