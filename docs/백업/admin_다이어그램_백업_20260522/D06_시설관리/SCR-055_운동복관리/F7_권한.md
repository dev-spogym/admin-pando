...
# F7 권한(RBAC) 분기 플로우 — SCR-055 운동복 관리
...
|-------|------|-------|------|------|
| TC-055-F7-001 | positive | trainer | SCR-055 진입 | 현황 조회만 가능, QR/상태변경/등록/삭제 버튼 숨김 |
