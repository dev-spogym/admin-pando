...
> **기준**: `공통.md` 1.1 전체 라우트 맵 (67개) + Next.js App Router 실제 파일 구조
...
| 파일 | 다이어그램 ID | 내용 |
|------|-------------|------|
| [N1_전체_사이트맵.md](N1_전체_사이트맵.md) | SITEMAP_N1 | 전체 67개 라우트 — 11개 도메인 subgraph |
| [N2_도메인별_사이트맵.md](N2_도메인별_사이트맵.md) | SITEMAP_N2 | 도메인 11개 각각 독립 다이어그램 |
| [N3_사이드바_계층트리.md](N3_사이드바_계층트리.md) | SITEMAP_N3 | 사이드바 메뉴 계층 트리 |
| [N4_URL패턴맵.md](N4_URL패턴맵.md) | SITEMAP_N4 | 파라미터화된 URL 패턴 |
| [N5_브레드크럼_계층.md](N5_브레드크럼_계층.md) | SITEMAP_N5 | 각 화면 브레드크럼 경로 |
| [N6_에러_복귀경로.md](N6_에러_복귀경로.md) | SITEMAP_N6 | 404/500/403 복귀 경로 |
