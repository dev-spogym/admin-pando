...
journey
    ...
    section 회원 관리 (핵심 업무)
      회원 목록 조회 /members: 5: fc
      신규 회원 등록 /members/new: 5: fc
      회원 상세 확인 /members/detail: 5: fc
      체성분 입력 /body-composition: 5: fc
      출석 처리 /attendance: 5: fc
    ...
    section POS 및 마케팅
      POS 판매 /pos: 5: fc
      POS 결제 처리 /pos/payment: 5: fc
      리드 관리 /leads: 4: fc
      전자계약 /contracts/new: 5: fc
      메시지 발송 /message: 4: fc
      쿠폰 적용 /message/coupon: 3: fc
...
| 공지사항 | `/notices` | ● | |
| 회원 목록 | `/members` | ● | |
| 회원 등록/수정 | `/members/new`, `/members/edit` | ● | |
...
| POS 전체 | `/pos`, `/pos/payment` | ● | |
| 매출 현황/통계 | `/sales*` | — | 차단 |
| 환불/미수금 | `/refunds`, `/unpaid` | — | 차단 |
| 상품 관리 | `/products*` | — | 차단 |
...
| 쿠폰/마일리지 | `/message/coupon`, `/mileage` | ● | |
| 전자계약 | `/contracts/new` | ● | |
| 설정 전체 | `/settings*` | — | 차단 |
