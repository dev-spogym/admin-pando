...
journey
    ...
    section 회원 관리
      회원 목록 조회 /members: 5: owner
      신규 회원 등록 /members/new: 5: owner
      회원 상세 확인 /members/detail: 5: owner
      회원 이관 처리 /members/transfer: 4: owner
      출석 현황 확인 /attendance: 5: owner

    section 매출 관리
      매출 현황 조회 /sales: 5: owner
      매출 통계 분석 /sales/stats: 5: owner
      통계 관리 /sales/statistics-management: 4: owner
      환불 처리 /refunds: 4: owner
      미수금 관리 /unpaid: 4: owner
      이연매출 조회 /deferred-revenue: 4: owner

    section 상품 및 시설
      상품 목록 관리 /products: 5: owner
    ...
    section 직원 및 급여
      ...
      직원 등록/수정: 5: owner
      직원 근태 확인 /staff/attendance: 4: owner
      급여 관리 /payroll: 5: owner
      급여 명세서 /payroll/statements: 4: owner
    ...
    section 마케팅 및 설정
      ...
      권한 설정 /settings/permissions: 5: owner
      키오스크 설정 /settings/kiosk: 4: owner
      IoT 설정 /settings/iot: 4: owner
```
