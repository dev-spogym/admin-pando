...
```mermaid
flowchart TD
    OPEN([DLG-001 열림]) -->|E_M2_D001_01| CHECK{미저장 변경사항 확인}

    CHECK -->|"E_M2_D001_02: 미저장 없음"| NORMAL_MODAL[일반 로그아웃 확인 모달]
    CHECK -->|"E_M2_D001_03: 미저장 있음"| WARN_MODAL[경고 문구 추가\n저장되지 않은 변경사항이 있습니다]

    NORMAL_MODAL -->|"E_M2_D001_04: 확인"| LOGOUT[로그아웃]
    WARN_MODAL -->|"E_M2_D001_05: 확인 (저장 없이)"| LOGOUT
    WARN_MODAL -->|"E_M2_D001_06: 취소"| STAY[현재 화면 유지]
