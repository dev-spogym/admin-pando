...
flowchart LR
    subgraph admin[admin-pando]
        A1[SCR-I001 통합출석관리]
        A2[SCR-082 키오스크설정]
        A2A[SCR-082A 키오스크 IoT 설정]
        A3[SCR-083 IoT 출입 관리]
...
sequenceDiagram
    ...
    kiosk->>admin: SCR-082/SCR-082A/SCR-083 설정 요청
    admin-->>kiosk: 메뉴 토글 / 인증 수단 / 얼굴 인식 정책 / 락커 전달 / 골프 / 주차 / 공지 / 단말·출입 장치 설정
...
4. **신규 설정 키 합의**: 화면/기능 설정은 admin/SCR-082, 단말/IoT 설정은 admin/SCR-082A 또는 admin/SCR-083에 명시 후 수신.
...
- admin/화면설계서/D09-설정관리/SCR-082-키오스크설정/키오스크-연동.md
- admin/화면설계서/D09-설정관리/SCR-082A-키오스크IoT설정/키오스크-연동.md
- admin/화면설계서/D09-설정관리/SCR-083-IoT출입관리/키오스크-연동.md
