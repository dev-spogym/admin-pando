...
export const ROUTE_TO_DOC: Record<string, { file: string; keywords: string[]; title: string; category: string }> = {
  // ── 본사관리 ──
  ...
  '/members/detail': { file: '회원관리.md', keywords: ['회원 상세', '3. 회원 상세'], title: '회원 상세', category: '회원관리' },
  '/members/transfer': { file: '회원관리.md', keywords: ['회원 지점 이관', '4. 회원 지점 이관'], title: '회원 이관', category: '회원관리' },
  '/body-composition': { file: '회원관리.md', keywords: ['체성분 관리', '5. 체성분 관리'], title: '체성분 관리', category: '회원관리' },
  ...
  // ── 시설관리 ──
  '/locker': { file: '시설관리.md', keywords: ['락커 관리', '1. 락커 관리'], title: '락커 관리', category: '시설관리' },
  '/locker/management': { file: '시설관리.md', keywords: ['사물함 배정', '2. 사물함 배정'], title: '사물함 배정', category: '시설관리' },
  ...
  '/settings/kiosk': { file: '설정관리.md', keywords: ['키오스크', '3. 키오스크'], title: '키오스크 설정', category: '설정관리' },
  '/settings/iot': { file: '설정관리.md', keywords: ['IoT', '4. IoT'], title: 'IoT 설정', category: '설정관리' },
  ...
  '/attendance': { file: '설정관리.md', keywords: ['출석 관리', '7. 출석 관리'], title: '출석 관리', category: '설정관리' },
