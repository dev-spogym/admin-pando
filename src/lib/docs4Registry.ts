...
export const DOCS4_SCREENS: Docs4Entry[] = [
  ...
  { code: "SCR-C003", kind: "SCR", domain: "D04", title: "시간표 일괄 등록", version: "V1", route: "/class-schedule", status: "stub" },
  { code: "SCR-C004", kind: "SCR", domain: "D04", title: "그룹 수업 템플릿", version: "both", route: "/class-templates", status: "stub" },
  ...
  { code: "SCR-C010", kind: "SCR", domain: "D04", title: "운동 프로그램 관리", version: "V2", route: "/exercise-programs", status: "stub" },
  { code: "SCR-C011", kind: "SCR", domain: "D04", title: "유효 수업 목록", version: "both", route: "/valid-lessons", status: "stub" },
  { code: "SCR-C012", kind: "SCR", domain: "D04", title: "대기열 관리", version: "both", route: "/class-waitlist", status: "stub" },
  { code: "SCR-C013", kind: "SCR", domain: "D04", title: "수업 평가 피드백", version: "both", route: "/class-feedback", status: "stub" },
  { code: "SCR-C015", kind: "SCR", domain: "D04", title: "수업 녹화 관리", version: "V2", route: "/class-recording", status: "stub" },
