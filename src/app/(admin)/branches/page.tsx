              ...
              <FormSection title="기본 정보" columns={2}>
                ...
                <div className="space-y-xs" >
                  ...
                  <div className="flex gap-xs" >
                    <Input
                      className={cn("flex-1 uppercase", codeAutoGenerated && "bg-accent-light/30")}
                      placeholder="예: SGJ"
            ...
            <div className="p-xl space-y-lg" >
              <div className="space-y-xs" >
                ...
                <div className="relative" >
                  ...
                  <Input className="pl-xl" placeholder="회원명 또는 연락처 입력" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-md" >
                <div className="space-y-xs" >
                  ...
                  <Input value="FitGenie CRM 종각점" disabled={true} />
                </div>
                <div className="space-y-xs" >
