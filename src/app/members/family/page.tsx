...
import { Users, Search, Plus, Link, Unlink, RefreshCw } from 'lucide-react';
...
export default function FamilyMemberPage() {
  ...
  const families = data.families.filter(family => {
    ...
    return family.main.includes(keyword) || family.members.some(member => member.includes(keyword));
  });
