...
import { ShoppingCart, AlertTriangle, Plus, ArrowDown, ArrowUp } from 'lucide-react';
    ...
    <AppLayout>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-green-50 rounded-xl border border-green-200 p-4">
          ...
          <p className="text-2xl font-bold text-green-600">3종</p>
        </div>
        ...
        <div className="bg-red-50 rounded-xl border border-red-200 p-4">
          ...
          <p className="text-2xl font-bold text-red-600">1종</p>
        </div>
      </div>
